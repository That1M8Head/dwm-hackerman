...
/* tagging */
static const char *tags[] = { "HACKERMAN LINUX" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_green, "-sb", col_black, "-sf", col_green, NULL };
